# 删除共享标签<a name="ZH-CN_TOPIC_0102003016"></a>
...
-   参数说明
    ...
    <div class="notice" id="note828312918357"><a name="note828312918357"></a><a name="note828312918357"></a><span class="noticetitle"> 注意： </span><div class="noticebody"><p id="p1128318923518"><a name="p1128318923518"></a><a name="p1128318923518"></a>调用删除共享标签接口删除标签时，如果标签的键中存在不被URL直接解析的特殊字符，需要对标签的键进行URL转义处理。</p>
    </div></div>
    </td>
    </tr>
    </tbody>
