...
-   share字段说明：
    ...
    <tr id="zh-cn_topic_0064390794_row2811743793851"><td class="cellrowborder" valign="top" width="18.84%" headers="mcps1.1.4.1.1 "><p id="p1846562021612"><a name="p1846562021612"></a><a name="p1846562021612"></a>consistency_group_id</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="58.19%" headers="mcps1.1.4.1.3 "><p id="p91301323313"><a name="p91301323313"></a><a name="p91301323313"></a>（API 微版本2.8以后支持）共享的可见程度。设置为true时公共可见，设置为false时私有个人可见，默认值为false。</p>
    </td>
    </tr>
    </tbody>
    </table>
...
-   响应样例
    ...
    ```
    {
      "share": {
        ...
        "links": [
          {
            "href": "https://8.46.196.47:8796/v2/07412155bf474db9a2f697fd978593d7/shares/f26d867f-9876-433d-8db2-25d210f29309",
            "rel": "self"
          },
          {
            "href": "https://8.46.196.47:8796/07412155bf474db9a2f697fd978593d7/shares/f26d867f-9876-433d-8db2-25d210f29309",
            "rel": "bookmark"
          }
        ],
