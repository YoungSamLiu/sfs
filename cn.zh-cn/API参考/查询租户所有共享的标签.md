# 查询租户所有共享的标签<a name="ZH-CN_TOPIC_0102003018"></a>
...
-   参数说明
    ...
    <td class="cellrowborder" valign="top" width="15.18%" headers="mcps1.1.4.1.2 "><p id="p18383165518521"><a name="p18383165518521"></a><a name="p18383165518521"></a>List&lt;tag&gt;</p>
    </td>
...
-   tag字段说明：
    ...
    <td class="cellrowborder" valign="top" width="22.09%" headers="mcps1.1.4.1.2 "><p id="p16405255185213"><a name="p16405255185213"></a><a name="p16405255185213"></a>List&lt;string&gt;</p>
    </td>
