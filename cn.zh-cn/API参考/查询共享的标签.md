# 查询共享的标签<a name="ZH-CN_TOPIC_0102003017"></a>
...
## 请求<a name="section1041111631610"></a>
...
-   参数说明
    ...
    <td class="cellrowborder" valign="top" width="15.18%" headers="mcps1.1.4.1.2 "><p id="p20248116135310"><a name="p20248116135310"></a><a name="p20248116135310"></a>List&lt;resource_tag&gt;</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="15.18%" headers="mcps1.1.4.1.2 "><p id="p128844115218"><a name="p128844115218"></a><a name="p128844115218"></a>List&lt;resource_tag&gt;</p>
    </td>
